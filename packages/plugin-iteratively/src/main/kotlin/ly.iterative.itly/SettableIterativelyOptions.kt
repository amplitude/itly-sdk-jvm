...
val DEFAULT_ITERATIVELY_OPTIONS = IterativelyOptions("")

/**
 * User configurable options for IterativelyPlugin
 */
data class SettableIterativelyOptions(
    ...
    data class Builder(
        ...
        fun build() = SettableIterativelyOptions(
    ...
    fun toIterativelyOptions(url:String, environment: Environment): IterativelyOptions {
